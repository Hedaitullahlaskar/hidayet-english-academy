...
import { studentJourney } from "@/content/about-data";
    ...
    <section className="bg-paper-100 py-20 dark:bg-navy-900 sm:py-28">
      <Container>
        <SectionHeading
          ...
          title="The Path Every HEA Student Walks"
          description="Not a promise of overnight fluency — a real, repeatable path from first hesitant sentence to real confidence."
        />
        <div className="relative mt-16">
          ...
          <ol className="grid gap-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 lg:gap-4">
            {studentJourney.map((item, i) => (
              <Reveal as="li" key={item.step} delay={i * 70} className="relative flex flex-col items-center text-center">
