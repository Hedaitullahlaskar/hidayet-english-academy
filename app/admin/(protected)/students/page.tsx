...
export default async function AdminStudentsPage() {
  ...
  return (
    <div>
      ...
      {students.length === 0 ? (
        <EmptyState className="mt-8" icon={<GraduationCap className="h-6 w-6" strokeWidth={1.75} />} title="No students yet" body="Students who register will appear here, manageable in one place." />
      ) : (
        <div className="mt-8">
